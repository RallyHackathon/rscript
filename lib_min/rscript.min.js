...
rsc.api.flow=function(a,b){var c=Ext.Array.toArray(arguments),d;a&&!a.isRscPromise?(d=a,c=Ext.Array.remove(c,d)):d={};d.layout="column";c=[d].concat(c);return rsc.api.stack.apply(rsc.stack,c)};
...
rsc.api.stack=function(a,b){var c=Ext.Array.toArray(arguments),d={};a&&!a.isRscProxy&&(d=a,c=Ext.Array.remove(c,d));var e=new rsc.Proxy(function(a){d=Ext.applyIf({xtype:"container"},d);this.cmp=a.add(d);Ext.Array.each(c,function(a){a.resolve(this.cmp)},this)});e.add=function(a){this.cmp?a.resolve(this.cmp):c.push(a)};return e};
rsc.api.text=function(a,b){var c=Ext.isString(a)?a:b||"",d=Ext.isNumber(a)?a:12,e=new rsc.Proxy(function(a){this.cmp=a.add({xtype:"container",html:c,style:{fontSize:d+"px"}})});Object.defineProperty(e,"text",{get:function(){return this.cmp&&this.cmp.getEl().dom.innerHTML},set:function(a){this.cmp?this.cmp.getEl().dom.innerHTML=a:c=a}});return e};rsc.Compiler=function(a){this.env=a||{}};
