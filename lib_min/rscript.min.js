...
rsc.api.iterationCombobox=function(){var a=new rsc.Promise(function(a){this.cmp=a.add({xtype:"rallyiterationcombobox"})});a.defineEventProperties("ready","change");a.surfaceMethodsAsProperties({getDisplayValue:"value",getValue:"ref",getQueryFromSelected:"filter"});return a};
