(function(){this.rsc=this.rsc||{};this.rsc.api=this.rsc.api||{};this.rsc.global=this})();rsc.api.CustomData=function(a,b){function c(a){return function(c){var b={};a.forEach(function(a){b[a]=c[a]});return b}}var a=function(a,b){Ext.isFunction(b)||(b=c(b));return a.map(b)}(a,b),d=Ext.create("Rally.data.custom.Store",{data:a});Object.defineProperty(d,"records",{writable:!1,configurable:!1,enumerable:!0,value:a});return d};
...
rsc.api.Grid=function(a,b,c){function d(a){var c=[];a.forEach(function(a){c.push({text:a,dataIndex:a})});c[0]&&(c[0].flex=1);return c}return new rsc.Proxy(function(e){if(Ext.isString(a)){var f=e.add({xtype:"container"});Rally.data.ModelFactory.getModel({type:a||"UserStory",success:function(a){a={xtype:"rallygrid",model:a};Ext.isArray(c)?a.storeConfig={filters:c}:Ext.isObject(c)&&(a.storeConfig={filters:[c]});b?(a.columnCfgs=b,a.autoAddAllModelFieldsAsColumns=!1):a.autoAddAllModelFieldsAsColumns=!0;
this.cmp=f.add(a)},scope:this})}else{var g={xtype:"rallygrid",store:a};Ext.isArray(c)?g.storeConfig={filters:c}:Ext.isObject(c)&&(g.storeConfig={filters:[c]});b?(-1===a.$className.indexOf("WsapiDataStore")&&(b=d(b)),g.columnCfgs=b,g.autoAddAllModelFieldsAsColumns=!1):g.autoAddAllModelFieldsAsColumns=!0;this.cmp=e.add(g)}})};
...
rsc.api.Stack=function(a,b){var c=Ext.Array.toArray(arguments),d={};a&&!a.isRscProxy&&!Ext.isString(a)&&(d=a,c=Ext.Array.remove(c,d));var e=new rsc.Proxy(function(a){d=Ext.applyIf({xtype:"container"},d);this.cmp=a.add(d);Ext.Array.each(c,function(a){a=rsc.util.stringToHtml(a);a.resolve(this.cmp)},this);this.loadMask=this.pending.loadMask;delete this.pending.loadMask});e.add=function(a){a=rsc.util.stringToHtml(a);this.cmp?a.resolve(this.cmp):c.push(a)};Object.defineProperty(e,"loadMask",{set:function(a){this.cmp?
a?this.cmp.getEl().mask("Loading..."):this.cmp.getEl().unmask():this.pending.loadMask=a}});return e};rsc.Compiler=function(a){this.env=a||{}};
...
rsc.util={toArray:function(a){return!a?[]:Ext.isArray(a)?a:[a]},stringToHtml:function(a){return Ext.isString(a)?new rsc.api.Html(a):a}};
