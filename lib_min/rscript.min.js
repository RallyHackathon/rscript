...
rsc.api.text=function(a,b){var c=Ext.isString(a)?a:b||"",d=Ext.isNumber(a)?a:12;return new rsc.Proxy(function(a){this.cmp=a.add({xtype:"container",html:c,style:{fontSize:d+"px"}})})};rsc.Compiler=function(a){this.env=a||{}};
