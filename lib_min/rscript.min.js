...
Ext.Array.each(a.concat(b),function(a){a=rsc.util.stringToHtml(a);a.resolve(e)});var f=Ext.widget("container");Ext.Array.each(c,function(a){a.resolve(f)});f.items.each(function(a){rsc.__root__.addDocked(a)});rsc.api.launch.initialTag&&(d.setToPage(rsc.api.launch.initialTag),delete rsc.api.launch.initialTag)};
...
rsc.api.Stack=function(a,b){var c=Ext.Array.toArray(arguments),d={};a&&!a.isRscProxy&&!Ext.isString(a)&&(d=a,c=Ext.Array.remove(c,d));var e=new rsc.Proxy(function(a){d=Ext.applyIf({xtype:"container"},d);this.cmp=a.add(d);Ext.Array.each(c,function(a){a=rsc.util.stringToHtml(a);a.resolve(this.cmp)},this)});e.add=function(a){a=rsc.util.stringToHtml(a);this.cmp?a.resolve(this.cmp):c.push(a)};return e};rsc.Compiler=function(a){this.env=a||{}};
