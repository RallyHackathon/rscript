(function(){this.rsc=this.rsc||{};this.rsc.api=this.rsc.api||{};this.rsc.global=this})();
rsc.api.launch=function(a){var b=Ext.Array.toArray(arguments),c=Ext.widget("container",{renderTo:Ext.getBody(),width:"100%",height:"100%",layout:"card",itemId:"rscriptRoot",setToPage:function(a){(a=this.down("#"+a))&&this.layout.setActiveItem(a)},goHome:function(){this.setToPage("__rscriptHomeCard__")}});window.rsc.__root__=c;var d=c.add({xtype:"container",width:"100%",height:"100%",itemId:"__rscriptHomeCard__"});Ext.Array.each(b,function(a){a.resolve(d)})};
...
rsc.api.page=function(a,b){var c=Ext.Array.toArray(arguments),c=Ext.Array.remove(c,a),d=new rsc.Proxy(function(b){if(b=b.up("#rscriptRoot"))this.cmp=b.add({xtype:"container",width:"100%",height:"100%",itemId:a}),Ext.Array.each(c,function(a){Ext.isString(a)&&(a=rsc.api.html(a));a.resolve(this.cmp)},this)});Object.defineProperty(d,"tag",{writable:!1,enumerable:!0,configurable:!1,value:a});d.add=function(a){Ext.isString(a)&&(a=rsc.api.html(a));this.cmp?a.resolve(this.cmp):c.push(a)};return d};
rsc.api.addNew=function(a,b){Ext.isString(a)&&(a=[a]);Ext.isString(b)&&(b=[b]);var c=new rsc.Proxy(function(c){this.cmp=c.add({xtype:"rallyaddnew",recordTypes:a,ignoredRequiredFields:b,showAddWithDetails:!1})});c.defineEventProperties("recordadd",{beforerecordadd:function(a){return function(c,b){a(new rsc.Record(b.record))}}});return c};
