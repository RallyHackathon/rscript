(function(){this.rsc=this.rsc||{};this.rsc.api=this.rsc.api||{};this.rsc.global=this})();Object.defineProperty(rsc.api,"HomeTag",{writable:!1,configurable:!1,enumerable:!0,value:"__rscriptHomeCard__"});Object.defineProperty(rsc,"RootId",{writable:!1,configurable:!1,enumerable:!0,value:"__rscriptRootId__"});
rsc.api.launch=function(a){var b=Ext.Array.toArray(arguments),c=Ext.widget("container",{border:!1,renderTo:Ext.getBody(),width:"100%",height:"100%",items:[{border:!1,xtype:"panel",layout:"card",itemId:rsc.RootId,setToPage:function(a){(a=this.down("#"+a))&&this.layout.setActiveItem(a)},goHome:function(){this.setToPage(rsc.api.HomeTag)}}]});rsc.__root__=c.items.items[0];var d=rsc.__root__.add({xtype:"container",width:"100%",height:"100%",itemId:rsc.api.HomeTag});Ext.Array.each(b,function(a){a.resolve(d)});
rsc.api.launch.initialTag&&(c.setToPage(rsc.api.launch.initialTag),delete rsc.api.launch.initialTag)};rsc.api.checkbox=function(a,b){var c=new rsc.Proxy(function(c){this.cmp=c.add({xtype:"checkbox",boxLabel:a||"",checked:!!b})});c.defineEventProperties({change:function(a){return function(c,b){a(b)}}});return c};
rsc.api.dock=function(a){var b=Ext.Array.toArray(arguments);return new rsc.Proxy(function(a){if(a=a.up("#"+rsc.RootId)){var d=Ext.widget("container",{border:!1});Ext.Array.each(b,function(a){Ext.isString(a)&&(a=rsc.api.html(a));a.resolve(d)});a.addDocked(d)}})};rsc.api.flow=function(a,b){var c=Ext.Array.toArray(arguments),d;a&&!a.isRscProxy&&!Ext.isString(a)?(d=a,c=Ext.Array.remove(c,d)):d={};d.layout="column";c=[d].concat(c);return rsc.api.stack.apply(rsc.stack,c)};
...
rsc.api.grid=function(a,b,c){return new rsc.Proxy(function(d){var e=d.add({xtype:"container"});Rally.data.ModelFactory.getModel({type:a||"UserStory",success:function(a){a={xtype:"rallygrid",model:a};Ext.isArray(c)?a.storeConfig={filters:c}:Ext.isObject(c)&&(a.storeConfig={filters:[c]});b?(a.columnCfgs=b,a.autoAddAllModelFieldsAsColumns=!1):a.autoAddAllModelFieldsAsColumns=!0;this.cmp=e.add(a)},scope:this})})};
rsc.api.iterationCombobox=function(){var a=new rsc.Proxy(function(a){this.cmp=a.add({xtype:"rallyiterationcombobox"})});a.defineEventProperties("ready","change");a.surfaceMethodsAsProperties({getDisplayValue:"value",getValue:"ref",getQueryFromSelected:"filter"});return a};
rsc.api.stack=function(a,b){var c=Ext.Array.toArray(arguments),d={};a&&!a.isRscProxy&&!Ext.isString(a)&&(d=a,c=Ext.Array.remove(c,d));var e=new rsc.Proxy(function(a){d=Ext.applyIf({xtype:"container"},d);this.cmp=a.add(d);Ext.Array.each(c,function(a){Ext.isString(a)&&(a=rsc.api.html(a));a.resolve(this.cmp)},this)});e.add=function(a){Ext.isString(a)&&(a=rsc.api.html(a));this.cmp?a.resolve(this.cmp):c.push(a)};return e};rsc.Compiler=function(a){this.env=a||{}};
