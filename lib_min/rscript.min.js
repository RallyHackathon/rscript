...
rsc.api.launch=function(a){var b=Ext.Array.toArray(arguments),c=Ext.widget("container",{border:!1,renderTo:Ext.getBody(),width:"100%",height:"100%",layout:"card",itemId:rsc.RootId,setToPage:function(a){(a=this.down("#"+a))&&this.layout.setActiveItem(a)},goHome:function(){this.setToPage(rsc.api.HomeTag)}});window.rsc.__root__=c;var d=c.add({xtype:"container",width:"100%",height:"100%",itemId:rsc.api.HomeTag});Ext.Array.each(b,function(a){a.resolve(d)});rsc.api.launch.initialTag&&(c.setToPage(rsc.api.launch.initialTag),
delete rsc.api.launch.initialTag)};rsc.api.checkbox=function(a,b){var c=new rsc.Proxy(function(c){this.cmp=c.add({xtype:"checkbox",boxLabel:a||"",checked:!!b})});c.defineEventProperties({change:function(a){return function(c,b){a(b)}}});return c};rsc.api.flow=function(a,b){var c=Ext.Array.toArray(arguments),d;a&&!a.isRscProxy&&!Ext.isString(a)?(d=a,c=Ext.Array.remove(c,d)):d={};d.layout="column";c=[d].concat(c);return rsc.api.stack.apply(rsc.stack,c)};
