...
rsc.api.launch=function(a,b,c){var a=rsc.util.toArray(a),b=rsc.util.toArray(b),c=rsc.util.toArray(c),d=Ext.widget("container",{border:!1,renderTo:Ext.getBody(),width:"100%",height:"100%",items:[{border:!1,xtype:"panel",layout:"card",itemId:rsc.RootId,setToPage:function(a){(a=this.down("#"+a))&&this.layout.setActiveItem(a)},goHome:function(){this.setToPage(rsc.api.HomeTag)}}]});rsc.__root__=d.down("#"+rsc.RootId);var e=rsc.__root__.add({xtype:"container",width:"100%",height:"100%",itemId:rsc.api.HomeTag});
Ext.Array.each(a.concat(b),function(a){a.resolve(e)});var f=Ext.widget("container");Ext.Array.each(c,function(a){a.resolve(f)});f.items.each(function(a){rsc.__root__.addDocked(a)});rsc.api.launch.initialTag&&(d.setToPage(rsc.api.launch.initialTag),delete rsc.api.launch.initialTag)};rsc.api.checkbox=function(a,b){var c=new rsc.Proxy(function(c){this.cmp=c.add({xtype:"checkbox",boxLabel:a||"",checked:!!b})});c.defineEventProperties({change:function(a){return function(c,b){a(b)}}});return c};
rsc.api.flow=function(a,b){var c=Ext.Array.toArray(arguments),d;a&&!a.isRscProxy&&!Ext.isString(a)?(d=a,c=Ext.Array.remove(c,d)):d={};d.layout="column";c=[d].concat(c);return rsc.api.stack.apply(rsc.stack,c)};
