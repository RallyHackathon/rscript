...
rsc.api.addNew=function(a,b){Ext.isObject(a)&&(a=[a]);Ext.isObject(b)&&(b=[b]);var c=new rsc.Promise(function(c){this.cmp=c.add({xtype:"rallyaddnew",recordTypes:a,ignoredRequiredFields:b,showAddWithDetails:!1})});c.defineEventProperties("recordadd",{beforerecordadd:function(a){return function(c,b){a(new rsc.Record(b.record))}}});return c};
...
Ext.Array.toArray(arguments);Ext.Array.each(b,function(a){Ext.isString(a)?Object.defineProperty(this,a,{set:function(b){if(this.cmp)this.cmp.on(a,b);else this.pending[a]=b}}):Ext.Object.each(a,function(a,b){Object.defineProperty(this,a,{set:function(c){c=b(c);if(this.cmp)this.cmp.on(a,c);else this.pending[a]=c}})},this)},this)}};rsc.Record=function(a){this._extRecord=a;this._wrap()};
rsc.Record.prototype={_wrap:function(){Ext.Array.each(this._extRecord.self.getFields(),function(a){Object.defineProperty(this,a.name,{set:function(b){this._extRecord.set(a.name,b)},get:function(){return this._extRecord.get(a.name)},enumerable:!0})},this)}};
