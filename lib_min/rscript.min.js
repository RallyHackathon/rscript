(function(){this.rsc=this.rsc||{};this.rsc.api=this.rsc.api||{};this.rsc.global=this})();rsc.api.launch=function(a){var b=Ext.Array.toArray(arguments),c=Ext.widget("container",{renderTo:Ext.getBody(),width:"100%",height:"100%"});Ext.Array.each(b,function(a){a.resolve(c)})};rsc.api.checkbox=function(a,b){var c=new rsc.Proxy(function(c){this.cmp=c.add({xtype:"checkbox",boxLabel:a||"",checked:!!b})});c.defineEventProperties({change:function(a){return function(c,b){a(b)}}});return c};
rsc.api.flow=function(a,b){var c=Ext.Array.toArray(arguments),d;a&&!a.isRscProxy?(d=a,c=Ext.Array.remove(c,d)):d={};d.layout="column";c=[d].concat(c);return rsc.api.stack.apply(rsc.stack,c)};
...
rsc.api.currentUser=function(){var a=Ext.clone(Rally.environment.getContext().getUser()),b=rsc.api.html("&nbsp;"+a._refObjectName+"&nbsp;");Ext.Object.each(a,function(a,d){Object.defineProperty(b,a,{writable:!1,enumerable:!0,configurable:!1,value:d})});return b};
...
rsc.api.stack=function(a,b){var c=Ext.Array.toArray(arguments),d={};a&&!a.isRscProxy&&(d=a,c=Ext.Array.remove(c,d));var e=new rsc.Proxy(function(a){d=Ext.applyIf({xtype:"container"},d);this.cmp=a.add(d);Ext.Array.each(c,function(a){a.resolve(this.cmp)},this)});e.add=function(a){this.cmp?a.resolve(this.cmp):c.push(a)};return e};rsc.Compiler=function(a){this.env=a||{}};
